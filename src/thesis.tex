...
\usepackage[backend=biber, sorting=none]{biblatex}  %reference manager
...
\renewcommand{\cftchapfont}{\small\chapsc\bfseries}
...
\renewcommand{\cftsecfont}{\small\sectionsc}
...
\titleformat{\chapter}[block]{\normalfont\chapsc\normalsize\raggedright}{\MakeUppercase{\thechapter}.}{1em}{\MakeUppercase{#1}}
...
\titleformat{\section}{\small\sectionsc\bfseries}{\thesection}{1em}{#1}

% Adjust subsection title formatting
\titleformat{\subsection}{\small\sectionsc\bfseries}{\thesubsection}{1em}{#1}

% Adjust subsubsection title formatting
\titleformat{\subsubsection}{\small\sectionsc\itshape}{\thesubsubsection}{1em}{#1}
