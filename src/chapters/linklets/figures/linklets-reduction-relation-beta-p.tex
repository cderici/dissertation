  ...
  \fbox{%
    \begin{minipage}{0.93\textwidth}
      ...
      \begin{align*}
        ...
        EP\;\llbracket (\bm{\Phi^I}(\lb\; x_{t}\; v_p\; \ldots \hspace{3cm} \rel \redoutput{\bm{\Phi^I}(\lb\; x_{t}\; v_p\; \ldots\; l\dash top\; \ldots)}{\rho_1}{\sigma_1} \\
        \; (\textbf{define\dash values}\; (x)\; v)\; l\dash top\; \ldots)) \rrbracket, \rho, \sigma\; &\;\; \hspace{1.5cm} \where \rho_1 = \rho[x\rightarrow cell],\; \sigma_1 = \sigma[cell\rightarrow v] \\
        ...
        \;          &\;\; \hspace{1.5cm} \where l\dash top_1\; \longrightarrow_{\beta_l}^*\; v_1 \\
        EP\;\llbracket (\bm{\Phi^I}(\la\; c\dash imps \; c\dash exps \; l\dash top \ldots)\; \hspace{0.5cm} \rel \redoutput{(\bm{\Phi^I}(\la\; c\dash imps \; c\dash exps \; l\dash top\; \ldots)\\
        \; LI\; \ldots) \rrbracket, \rho, \sigma\; &\;\; \hspace{5cm} \; LI\; \ldots \textbf{\#:t}\; x_{t})}{\rho}{\sigma_1} \\
        \;  &\;\; \hspace{1.5cm} \where x_t \notin \mathit{dom}(\sigma), \sigma_1 = \sigma[x_t\rightarrow (LI)] \\
        EP\;\llbracket (\bm{\Phi^I}(\la\; c\dash imps \; c\dash exps \; l\dash top \ldots)\; \hspace{0.5cm} \rel \redoutput{(\bm{\Phi^I}(\lb\; x_{t}\; l\dash top\; \ldots))}{\rho_2}{\sigma_1} \\
