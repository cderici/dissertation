...
\label{chapter:linklets}
	...
	\section[\texorpdfstring{Formal Operational Semantics of Linklets}{Formal Semantics for Linklets}]{Formal Operational Semantics of Linklets}
		...
		\begin{paragraph-here}% 11
			\figref{fig:linklets-reduction-relation} shows the reduction relation, $\beta_p$, that implements the evaluation of linklet programs, together with the reduction relation for
			...
			reductions from programs to values. Some of the reduction rules for trivial forms such as \racketcode{seq} and \racketcode{let-inst} are omitted for brevity.
		\end{paragraph-here}
