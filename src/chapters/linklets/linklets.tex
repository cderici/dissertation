...
\label{chapter:linklets}
	...
	\section[\texorpdfstring{Linklets as Units of Compilation}{Semantics for Linklets}]{Linklets as Units of Compilation}
		...
		\begin{paragraph-here}
			As our example, let’s consider the following interactions in a \gls{repl} environment. We first define a closure \racketcode{k} that includes a free variable \racketcode{a}, then we define the variable \racketcode{a}, and invoke the closure to get the result 10.
		\end{paragraph-here}
