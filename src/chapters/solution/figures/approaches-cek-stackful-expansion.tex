\begin{figure}[ht]
  ...
  \legend{Racket on Pycket, Racket on Pycket with hybrid model, Racket on Chez}
  \end{axis}
  \end{tikzpicture}
  \caption{Program-expansion performance. CEK-only Racket on Pycket vs Racket on Pycket with CEK \& Stackful hybrid model vs.\ Racket on Chez --- lower is better.}
