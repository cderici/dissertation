\begin{figure}[ht]
  ...
  \legend{Racket on Pycket, Racket on Pycket with extended green variables, Racket on Chez}
  \end{axis}
  \end{tikzpicture}
  \caption{Program‑expansion performance. Racket on Pycket with and without the extended green variables optimization vs.\ Racket on Chez -- lower is better.}
