...
\node[callout] (n18) at ($(ColX)+(0,0.29)$) {18};
\node[callout] (n8)  at ($(ColX)+(0.03,0.36)$) {8};
\node[callout] (n3)  at ($(ColX)+(0.06,0.425)$) {3};
\node[callout] (n1)  at ($(ColX)+(0.09,0.46)$) {1};
\node[callout] (n5)  at ($(ColX)+(0.09,0.62)$) {5};
\node[callout] (n4)  at ($(ColX)+(0.12,0.652)$) {4};
