...
\addplot[
  ...
  \legend{Original Pycket, Pycket with Meta-hints, Pycket with extended green variables}
  \end{axis}
  \end{tikzpicture}
  \caption{Experiment results for targeted improvement approaches running Branchy. Lower is better.}
