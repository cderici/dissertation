\chapter{Approaches to Improve Self-hosting Performance}
  ...
  \paragraph{}%
    ...
    \paragraph{}%
      A prominent contributor to the performance overhead in self-hosting via meta-tracing JIT compilers is the considerable memory pressure arising from frequent heap allocations, especially continuations and environments used by the CEK machine in Pycket. [TODO: Here's a brief summary ]
