\newcommand{\pyckethsep}{10cm} % tweak this value for horizontal gap
...
\begin{figure}[!h]
  ...
  \begin{tikzpicture}[scale=0.6, font=\footnotesize]
    ...
    \begin{scope}[shift={(\pyckethsep,0)}] % Use the variable here!
      % Main vertical flow
      ...
      % Expander linklet - higher and centered between m3 and m4
      ...
      % Horizontal, then vertical arrows into the north/south sides of expander
  ...
  \label{fig:pycket-sidebyside-workflow-AB}
\end{figure}
