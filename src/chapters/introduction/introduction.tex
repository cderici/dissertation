    ...
    \section[\texorpdfstring{Dissertation Structure \& Contributions}{Structure \& Contributions}]{Dissertation Structure \& Contributions}
        ...
        \paragraph{}% 13
            ...
            \begin{itemize}
                ...
                \item The first formalization of linklet semantics, providing an operational semantics to clearly reason about their behavior. % linklets
                \item Rudimentary operational semantics for a hybrid computational model (\racketcode{CEK} \& Stackful) that utilizes both stack and the heap in an intelligent way for optimized memory use. % hybrid model
