\begin{figure}[ht]
  ...
  coordinates {
    ...
    (nboyer,4.010) +- (0,0.00820)
    (earley,4.121) +- (0,0.0132)
    (paraffins,5.512) +- (0,0.0123)
    (g. mean,0.9472) +- (0,0)
    };
  ...
  coordinates {
    ...
    (nboyer,3.524) +- (0,0.00421)
    (earley,3.722) +- (0,0.00972)
    (paraffins,5.261) +- (0,0.00903)
    (g. mean,0.9005) +- (0,0)
    };
  \legend{Racket on Pycket, Original Pycket}
  \end{axis}
  \end{tikzpicture}
  \caption{Fully-expanded program evaluation performance. Racket on Pycket vs Original Pycket, relative to Racket 8.18 -- lower is better.}
