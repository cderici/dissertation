\begin{figure}[ht]
  ...
  \begin{axis}[
    ...
    width=15cm,
    height=8cm,
    ylabel={Relative Runtime (to Racket)},
    xlabel={Scheme Benchmarks},
    symbolic x coords={string,sumloop,sumfp,fft,mbrot,ctak,pnpoly,sum,fibfp,pi,triangl,array1,simplex,puzzle,primes,diviter,fib,nqueens,takl,cpstak,gcold,ack,gcbench,graphs,divrec,mazefun,sboyer,tak,perm9,nboyer,earley,paraffins},
    xtick=data,
