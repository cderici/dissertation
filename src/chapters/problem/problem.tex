\chapter[\texorpdfstring{PERFORMANCE EVALUATION OF SELF-HOSTING ON META-TRACING}
	...
	\label{section:memory}
		...
		\begin{table}[!h]
			...
			\bottomrule
			\end{tabular}
			\caption{Memory footprint of original Pycket vs Pycket hosting Racket, both loading \racketcode{racket/base}. Nursery size: 32M}
