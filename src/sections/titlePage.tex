...
\newcommand{\thesisTitle}{Self-Hosting Functional Programming Languages on Meta-Tracing JIT Compilers}
\newcommand{\yourName}{Caner Derici}
\newcommand{\yourDepartment}{Computer Science}
\newcommand{\yourSchool}{Indiana University}
\newcommand{\yourMonth}{Sep}
