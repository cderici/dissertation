...
\lstdefinestyle{rptrace-style}{
  ...
  numbers=none,
  numbersep=-5pt,
  numberstyle=\normalsize\ttfamily\color{gray},
  basicstyle=\ttfamily\fontsize{10.5}{11}\selectfont,
  sensitive=true,
  tabsize=2,
  breaklines=true,
  columns=fullflexible,
...
\lstdefinestyle{python-style}{
  ...
  basicstyle=\small\ttfamily\fontsize{10.5}{12.5}\selectfont,
  sensitive=true,
  tabsize=2,
  breaklines=true,
  columns=fullflexible,
...
\lstdefinestyle{inline-python}{
  ...
  numbersep=-5pt,
  numberstyle=\small\ttfamily\color{black},
  basicstyle=\small\ttfamily\linespread{0.85}\selectfont,
  sensitive=true,
  tabsize=2,
  breaklines=true,
  columns=fullflexible,
